...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="mb-6 flex h-full flex-col lg:mb-2 lg:p-4">
      {/* Imagen */}
      <div className="mb-3 border-4 border-card flex h-64 w-full animate-fade-down animate-duration-1500 items-center justify-center overflow-hidden sm:h-56 2xl:h-64">
        <button
          type="button"
      ...
      <div className="flex flex-col flex-1">
        <h2 className="bg-card p-2 text-white text-center mb-2 animate-fade-right animate-duration-1500 text-xl font-bold capitalize 2xl:text-2xl">
          {project.title}
        </h2>

        <p className="mb-4 flex-1 text-start text-black 2xl:text-lg">
          {project.desc}
        </p>
        ...
        >
          ...
          >
            <button
              type="button"
              onClick={() => setIsImageOpen(false)}
              className="absolute right-2 top-2 z-10 flex size-10 items-center justify-center bg-white text-primary shadow-lg transition-colors duration-300 hover:bg-primary hover:text-white"
