  ...
  return (
    <>
      <div className="container flex flex-col lg:flex-row lg:justify-between gap-15 items-center">
        <div className="animate-fade-right animate-duration-1500 bg-card px-6 py-10 lg:w-2/5 rounded-xl h-2/3 mt-5">
          <p className="text-2xl lg:text-xl text-bg text-start">
            Tengo conociminto y experiencia en varias tecnologias, tanto de
            <span className="text-white font-bold"> frontend</span>,
            <span className="text-white font-bold"> backend</span>, algo de
            <span className="text-white font-bold"> devops</span> a nivel basico
            (lo suficiente para alojar y desplegar una aplicacion en un servidor
            AWS EC2). Mi proximo paso es aprender sobre machine learning y
            sistemas de IA
          </p>
        </div>
        ...
        <div className="p-4 rounded-xl">
          ...
          <div className="animate-fade-left animate-duration-2000  lg:flex items-center gap-10 mb-2">
            <h2 className="text-2xl mb-4 text-primary font-bold">Backend</h2>
          ...
          <p className="mb-10 font-bold text-center">
            Principal: <span className="text-primary">PYTHON + DJANGO</span>
          </p>

          <div className="animate-fade-left animate-duration-2000 lg:flex items-center gap-10 mb-2">
            <h2 className="text-2xl mb-4 rounded-lg text-primary font-bold">
              Frontend
            </h2>
            <div className="border-black border-2 overflow-hidden w-full max-w-2xl bg-surface p-5 rounded-lg">
              <div className="relative">
          ...
          <p className="font-bold text-center">
            Principal: <span className="text-primary">REACT + TYPESCRIPT</span>
          </p>
        </div>
      </div>
    </>
